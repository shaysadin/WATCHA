...
const Billboard = () => {
    ...
    return(
        <div className="relative h-[48.50vw]">
            <video className="w-full h-[48.50vw] object-cover brightness-[60%]" autoPlay muted loop poster={data?.thumbnailUrl} src={data?.videoUrl}></video>
